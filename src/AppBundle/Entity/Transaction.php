...
class Transaction
{
    ...
    */
    public function setType($type)
    {
        ...
        }else if ($this->getType()=="author_quote"){
           $this->label = "New view in your status : ".$this->getStatus()->getDescription();
        }else if ($this->getType()=="add_quote"){
           $this->label = "You add new status : ".$this->getStatus()->getDescription();
        }else if ($this->getType()=="add_youtube"){
           $this->label = "You upload new youtube video : ".$this->getStatus()->getTitle();
        }else if ($this->getType()=="author_youtube"){
           $this->label = "New view in your youtube video : ".$this->getStatus()->getTitle();
        }else if ($this->getType()=="share_youtube"){
           $this->label = "You share the youtube video : ".$this->getStatus()->getTitle();
        }else if ($this->getType()=="view_youtube"){
           $this->label = "You watch the youtube video : ".$this->getStatus()->getTitle();
        ...
        }else if ($this->getType()=="author_video"){
           $this->label = "New view in your video : ".$this->getStatus()->getTitle();
        ...
        }else if ($this->getType()=="author_image"){
           $this->label = "New view in image : ".$this->getStatus()->getTitle();
        ...
        }else if ($this->getType()=="author_gif"){
           $this->label = "New view in your Gif : ".$this->getStatus()->getTitle();
        }else if ($this->getType()=="invited_user"){
           $this->label = "You Invite the User : ".$this->getInvited()->getName();
        }else if ($this->getType()=="register_user"){
           $this->label = "You has been registered in the app";
        }
        return $this;
    }
    /**
